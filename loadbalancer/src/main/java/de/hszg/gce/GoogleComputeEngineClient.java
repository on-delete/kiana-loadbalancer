...
public class GoogleComputeEngineClient {
    ...
    public boolean createGCE(String name, GCEProjectLocationParameter gceProjectLocationParameter) throws NotAuthenticatedException {
        ...
        try {
            StringEntity request = new StringEntity("{ \"name\": \"" + name + "\", \"zone\": \"https://www.googleapis.com/compute/v1/projects/test-cand2release/zones/us-central1-a\", \"machineType\": \"https://www.googleapis.com/compute/v1/projects/test-cand2release/zones/us-central1-a/machineTypes/f1-micro\", \"metadata\": { \"items\": [] }, \"tags\": { \"items\": [ \"http-server\" ] }, \"disks\": [ { \"type\": \"PERSISTENT\", \"boot\": true, \"mode\": \"READ_WRITE\", \"deviceName\": \"" + name + "\", \"autoDelete\": true, \"initializeParams\": { \"sourceImage\": \"https://www.googleapis.com/compute/v1/projects/test-cand2release/global/images/compute-node\", \"diskType\": \"https://www.googleapis.com/compute/v1/projects/test-cand2release/zones/us-central1-a/diskTypes/pd-standard\" } } ], \"canIpForward\": false, \"networkInterfaces\": [ { \"network\": \"https://www.googleapis.com/compute/v1/projects/test-cand2release/global/networks/default\", \"accessConfigs\": [ { \"name\": \"External NAT\", \"type\": \"ONE_TO_ONE_NAT\" } ] } ], \"description\": \"\", \"scheduling\": { \"preemptible\": false, \"onHostMaintenance\": \"MIGRATE\", \"automaticRestart\": true }, \"serviceAccounts\": [ { \"email\": \"default\", \"scopes\": [ \"https://www.googleapis.com/auth/devstorage.read_only\", \"https://www.googleapis.com/auth/logging.write\" ] } ] }");
